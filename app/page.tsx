...
export default function Home() {
  ...
  return <main className="shell">
    ...
    <section id="thanks" className="thanks panel"><div className="thanks-copy"><h2>Thank you</h2><p>귀한 시간 내어 함께해 주셔서<br />진심으로 감사드립니다.</p><time dateTime="2026-08-15">2026.08.15</time></div><p className="thanks-signature">With love,<br />Jaerin &amp; Miyeon</p><div className="thanks-family-frame"><Image src={thankYouArtwork} alt="바닷가에 함께 앉은 가족 수채화 일러스트" sizes="(max-width: 375px) 100vw, 375px" quality={85} loading="lazy" /></div></section>
